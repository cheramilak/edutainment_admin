<div>
    <div class="flex-1 self-stretch max-md:pt-6">
        <flux:heading>{{  'Parents' }}</flux:heading>
        <flux:subheading>{{ 'Managem parents' }}</flux:subheading>
                        ...
                        @foreach ($users as $item)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <a href="{{ route('students', $item->id) }}">
                                        <flux:button variant="primary">Students</flux:button>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
