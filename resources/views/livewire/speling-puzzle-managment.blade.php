<div>
    <div class="flex-1 self-stretch max-md:pt-6">
        <flux:heading>{{ 'Speling question' }}</flux:heading>
        <flux:subheading>{{ 'manage puzzle' }}</flux:subheading>
                        ...
                        @foreach ($quizs as $item)
                            <tr
                                ...
                                <th scope="row"
                                    ...
                                    <img class="h-35 max-w-lg rounded-lg" src="{{ asset('storage/' . $item->image) }}"
    ...
    @include('livewire.components.speling-form')
